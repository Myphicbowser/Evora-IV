...
/mob/observer/ghost/verb/latepartynew()
	...
	switch(partyteam)
		...
		if("Sekites")
			...
			to_chat(usr, "<span class='warning'><b><font size=3>You are expected to demand people to join your cult before you kill them, if able. Embrace your Blessings in your Ruinous Powers Tab! Ensure the Commander and Berzerker Chosen armor are donned. Follow their wearers in glorious battle upon the nearby planet of Evora IV. Work alongside your fellow Blood Pact warriors using the Dark Tongue. You may be Khornate, but you are extremely well disciplined. Harvest souls and sacrifice for the Blood God!</b></font size=3>") //tells mob to do thing
